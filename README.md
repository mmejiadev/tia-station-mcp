...
which we inherit the architecture, code conventions and error model. **76 tools**, 43 that read and 33 in
the file that changes things — 32 of which go through the guard, the thirty-third being the
