...
which we inherit the architecture, code conventions and error model. **73 tools**, 43 that read and 30 in
the file that changes things — 29 of which go through the guard, the thirtieth being the
