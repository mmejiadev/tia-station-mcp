...
which we inherit the architecture, code conventions and error model. **71 tools**, 42 that read and 29 in
the file that changes things — 28 of which go through the guard, the twenty-ninth being the
